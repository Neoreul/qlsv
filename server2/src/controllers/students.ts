...
class StudentRouter extends RootRouter {
	constructor() {
		...
		this.router.post("/api/students/create-or-modify", validUserInput.createOrModifyStudent, this.handleStudentCreateOrModify.bind(this));
		this.router.post("/api/students/change-password", validUserInput.changePassword, this.handleStudentChangePassword.bind(this));
		this.router.post("/api/students/addresses", this.handleStudentGetAddresses.bind(this));
		this.router.post("/api/students/add-address", validUserInput.validateStudentAddress, this.handleStudentAddAddress.bind(this));
		this.router.post("/api/students/update-address", validUserInput.validateStudentAddress, this.handleStudentUpdateAddress.bind(this));
	...
	async handleGetStudents(req: any, res: any) {
		try {

			let skip, limit, keyword, class_id, subject_id, query: any = {};
	...
	async handleGetStudent(req: any, res: any) {
		try {
	...
	async handleStudentCreateOrModify(req: any, res: any) {
		try {
	...
	async handleStudentChangePassword(req: any, res: any) {
		try {
			let student_id = Number(req.body.id);
	...
	async handleStudentGetAddresses(req: any, res: any) {
		try {
	...
	async handleStudentAddAddress(req: any, res: any) {
		try {
			let student_id = Number(req.body.id);
	...
	async handleStudentUpdateAddress(req: any, res: any) {
		try {
	...
	async handleStudentRemoveAddress(req: any, res: any) {
		try {
	...
	async handleRemoveStudent(req: any, res: any) {
		try {
	...
	async handleChangeStatus(req: any, res: any) {
		try {
